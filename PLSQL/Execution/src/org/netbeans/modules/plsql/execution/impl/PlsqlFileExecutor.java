        ...
        while (tokenizer.hasMoreTokens()) {
            ...
            if (format) {
                ...
                while (dotTokenizer.hasMoreTokens()) {
                    ...
                    if (cache.isTable(dotToken) || cache.isView(dotToken)) {
                        isUpper = true;
                    }
                }
                ...
                if (!isUpper) {
                    ...
                    while (otherTokenizer.hasMoreTokens()) {
                        ...
                        if (!otherToken.startsWith("'")
                                && cache.isTable(otherToken) || cache.isView(otherToken)) {
                            isUpper = true;
                        }
                    }
                }
            ...
            for (PlsqlExecutableObject exeObj : executableObjs) {
                ...
                if (exeObj.getType() == PlsqlExecutableObjectType.DECLAREEND) {
                    try {
                        ...
                        processDbmsOutputMessages(jdbcConnection, io.getOut());
        ...
        try {
            ...
            if (file.exists()) {
                ...
                if (obj != null) {
                    ...
                    executePLSQL(blockMaker.makeExceutableObjects(), document);
                }
            } else {
