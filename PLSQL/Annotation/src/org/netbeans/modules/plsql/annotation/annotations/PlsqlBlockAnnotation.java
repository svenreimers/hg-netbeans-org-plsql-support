...
/**
 * Abstract class for annotations based on PlsqlBlocks
 * @author YADHLK
 */
public abstract class PlsqlBlockAnnotation extends PlsqlAnnotation {

   public abstract void evaluateAnnotation(final Map<Integer, List<PlsqlAnnotation>> annotationsToAdd,
         final Document doc, final PlsqlBlock block, final Document specDoc, final PlsqlBlockFactory specBlockFac);
