...
/**
 * Check for unreachable statements in functions
 * @author YADHLK
 */
public class PlsqlUnreachableAnnotation extends PlsqlBlockAnnotation {

   private PlsqlUnreachableAnnotation() {
   } //Used for configuration only

   public static PlsqlUnreachableAnnotation getDummyInstance() {
      return new PlsqlUnreachableAnnotation();
   }
   ...
   public String getErrorToolTip() {
      return NbBundle.getMessage(this.getClass(), "unreachable_annotation");
   }

   @Override
   public String getAnnotationType() {
      return "Plsql-unreachable-annotation";
   }
   ...
   public void evaluateAnnotation(Map<Integer, List<PlsqlAnnotation>> annotationsToAdd, Document doc, PlsqlBlock block, Document specDoc, PlsqlBlockFactory specBlockFac) {
      try {
         ...
         List<Integer> lstUnreachable = new ArrayList<Integer>();
         PlsqlMethodAnnotationUtil.getUnreachableOffsets(doc, block, lstUnreachable);
         for (Integer lineOffset : lstUnreachable) {
            exists = true;
            PlsqlUnreachableAnnotation annotation = new PlsqlUnreachableAnnotation(lineOffset, block.getStartOffset());
