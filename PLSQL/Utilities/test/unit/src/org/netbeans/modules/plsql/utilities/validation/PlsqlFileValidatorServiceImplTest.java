...
public class PlsqlFileValidatorServiceImplTest {
    ...
    private static final String MORE_INFO = "See org.netbeans.modules.plsql.utilities.PlsqlFileValidatorService for more info";
     ...
     */
    @Test
    public void shouldOnlyReturnTrueForValidTDBFileNotForAnyOtherKind() throws IOException {
        System.out.println("shouldOnlyReturnTrueForValidTDBFileNotForAnyOtherKind");
        FileSystem fs = FileUtil.createMemoryFileSystem();
        ...
        fileObject = fs.getRoot().createData("test", "SPec");
        dataObject = DataObject.find(fileObject);
        assertFalse(MORE_INFO, instance.isValidTDB(dataObject));
        fileObject = fs.getRoot().createData("test", "api");
        dataObject = DataObject.find(fileObject);
        assertFalse(MORE_INFO, instance.isValidTDB(dataObject));
        fileObject = fs.getRoot().createData("test", "API");
        dataObject = DataObject.find(fileObject);
