...
public class PlsqlCodeCompletionProvider implements CompletionProvider {
    ...
    /** Creates a new instance of PLSQLCodeCompletionProvider */
    public PlsqlCodeCompletionProvider() {
    }
    ...
    static class Query extends AsyncCompletionQuery {
        ...
        public Query(BaseDocument doc, int queryType) {
            ...
            this.dbConnectionProvider = DatabaseConnectionManager.getInstance(doc);
            this.cache = dbConnectionProvider != null && dbConnectionProvider.hasConnection()
                    ? DatabaseContentManager.getInstance(dbConnectionProvider.getTemplateConnection()) : null;
        }
      ...
      private void findAndCloneToArgumentVersion(List localMethods, MethodCallContext callContext, List<CompletionItem> codeCompletionItems) {
        ...
        protected List<CompletionItem> actualQuery(CompletionResultSet completionResultSet, Document document, int caretOffset) {
            ...
            if (updateCache) {
                if (!dbConnectionProvider.isOnline()) {
            ...
            try {
                ...
                if (dbConnectionProvider.isOnline() && completionResultSet != null) {
                ...
                PlsqlCodeCompletionItemsProvider itemProvider = new PlsqlCodeCompletionItemsProvider(doc);
                String schema = null;
