 ...
 * @author chrlse
 */
class PlsqlStandaloneMethodTarget extends AbstractPlsqlGotoTarget {

   public PlsqlStandaloneMethodTarget(final String name, final int position, final DataObject sourceDataObject,
