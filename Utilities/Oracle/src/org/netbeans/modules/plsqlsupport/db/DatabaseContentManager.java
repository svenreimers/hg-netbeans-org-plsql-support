...
public class DatabaseContentManager {
    ...
    private static final File cacheDir = Places.getCacheSubdirectory("plsql");
    ...
    private DatabaseContentManager(DatabaseConnection connection) {
        ...
        this.directory = cacheDir.getPath() + "/" + this.user + "@" + databaseURL.toUpperCase(Locale.ENGLISH);
    }
    ...
    public Map<String, String> getMethodObjects(String pkgName, DatabaseConnection databaseConnection) {
        if (isUpdateRunning()) {
            ...
            try {
                return DatabaseContentUtilities.getMethodNames(pkgName, databaseConnection.getSchema(), databaseConnection.getJDBCConnection());
            } catch (SQLException ex) {
                fireExceptionThrown(ex);
                return new HashMap<String, String>();
            }
    ...
    public Map<String, String> getPackageMembers(String pkgName, DatabaseConnection databaseConnection) {
        if (isUpdateRunning()) {
            ...
            try {
                return DatabaseContentUtilities.getPackageMembers(pkgName, databaseConnection.getSchema(), databaseConnection.getJDBCConnection());
            } catch (SQLException ex) {
                fireExceptionThrown(ex);
                return new HashMap<String, String>();
            }
