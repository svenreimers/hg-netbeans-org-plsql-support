...
public final class RebuildCacheAction extends CookieAction {
   ...
   protected void performAction(Node[] activatedNodes) {
      ...
      DatabaseContentManager cacheManager = DatabaseContentManager.getInstance(connectionProvider.getTemplateConnection());
      cacheManager.clearCache();
      cacheManager.updateCache(connectionProvider, true);
   }
   ...
   public String getName() {
      return NbBundle.getMessage(RebuildCacheAction.class, "CTL_RebuildCacheAction");
   }
