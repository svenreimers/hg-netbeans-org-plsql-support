...
public final class UpdateCacheAction extends CookieAction {
   ...
   protected void performAction(Node[] activatedNodes) {
      ...
      DatabaseContentManager.getInstance(connection).updateCache(connectionProvider, true);
   }
   ...
   public String getName() {
      return NbBundle.getMessage(UpdateCacheAction.class, "CTL_UpdateCacheAction");
   }
