 ...
 */
public class PlsqlFileFinderTest extends NbTestCase {
   
   public PlsqlFileFinderTest(final String name) {
      super(name);
   }
   ...
   /**
    * Test of findPlsqlFiles method, of class PlsqlFileScanner.
    */
   @Test
   public void testFindPlsqlFiles() throws IOException {
      System.out.println("findPlsqlFiles");
      final File rootFolderB = new File(getWorkDir(), WORKSPACE_B);
      PlsqlFileFinder instance = new PlsqlFileFinder(rootFolderB);
      Collection<File> result = instance.findPlsqlFiles();
      for (File file : result) {
         System.out.println(file.getName());
         assertFalse(file.getCanonicalPath().contains(".ifs"));
      }
