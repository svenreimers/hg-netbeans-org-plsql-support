 ...
 * @author ChrLSE
 */
public class PlsqlTableTarget extends AbstractPlsqlGotoTarget {

   public PlsqlTableTarget(final String name, final int position, final DataObject sourceDataObject,
           final Project project, final Document sourceDocument) {
      super(name, position, sourceDataObject, project, sourceDocument);
      this.type = PlsqlBlockType.TABLE;
      this.synonym = cache.getTableForSynonym(name);
   }
