...
import org.netbeans.modules.plsqlsupport.db.ui.DatabaseNode;
...
public class ImportantFilesNodeFactoryImpl implements NodeFactory {
    ...
    public NodeList createNodes(Project project) {
        ...
        DatabaseConnectionManager item = project.getLookup().lookup(DatabaseConnectionManager.class);
        if (item != null) {
           DatabaseNode nd = new DatabaseNode(proj);
