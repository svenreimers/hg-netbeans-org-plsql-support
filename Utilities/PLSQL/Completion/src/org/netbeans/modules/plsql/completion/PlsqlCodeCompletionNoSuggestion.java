 ...
 * @author chawlk
 */
public class PlsqlCodeCompletionNoSuggestion extends PlsqlCodeCompletionItem {

  
   /** Creates a new instance of PLSQLCodeCompletionItem */
   public PlsqlCodeCompletionNoSuggestion() {
      super("", null);
   }

   public int getPreferredWidth(Graphics graphics, Font font) {
      return CompletionUtilities.getPreferredWidth("No suggestions...", "", graphics, font);
   }
   
   public void render(Graphics graphics, Font font, Color color, Color color0, int width, int height, boolean selected) {
      CompletionUtilities.renderHtml(getIcon(), "No suggestions...", "", graphics, font,
